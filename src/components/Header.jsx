...
function ThemeToggle() {
  ...
  return (
     ...
     {options.map((btn, index) => ( 
       <button key={index} onClick={()=> setTheme(btn.text)} className={`group rounded-full bg-white/90 px-3 py-2 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur transition dark:bg-zinc-400/90 dark:ring-white/10 dark:hover:ring-white/20`}>
         {btn.icon}
       </button>
     ))}
   </div>
